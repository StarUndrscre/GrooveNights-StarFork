...
local GraphicsLevels = { "Low", "Medium", "High", "Very High", "Maximum" }
...
{
	DisplayColorDepth		= {	16,	32,	32,	32, 32	},
	TextureColorDepth		= {	16,	32,	32,	32, 32	},
	MovieColorDepth			= {	16,	16,	16,	32, 32	},
	MaxTextureResolution		= {	256,	512,	1024,	2048,	4096	},

	DelayedTextureDelete		= {	false,	false,	false,	true, true	},
	DelayedModelDelete		= {	false,	false,	true,	true, true	},
	PalettedBannerCache		= {	false,	false,	true,	true, true	},

	TrilinearFiltering		= {	false,	false,	true,	true, true	},
	AnisotropicFiltering		= {	false,	false,	true,	true, true	},

	BannerCache			= {	0,	0,	1,	1,	1	},

	-- XXX: this is here so we have some way of setting it...
	ThreadedMovieDecode		= {	false,	false,	false,	true, true	},
	SmoothLines			= {	false,	true,	true,	true, true	},
}
